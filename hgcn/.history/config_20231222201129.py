...
config_args = {
    'training_config': {
        ...
        'log_path': ('logs', 'log_path to save training process'),
    ...
    'model_config': {
        ...
        'model': ('GCNHyperGCN', 'which encoder to use, can be any of [HyperGCN]'),
        'dim': (128, 'embedding dimension'),
        'manifold': ('Hyperboloid', 'which manifold to use, can be any of [Euclidean, Hyperboloid]'),
